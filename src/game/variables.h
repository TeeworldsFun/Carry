...
MACRO_CONFIG_INT(SvInsta, sv_insta, 0, 0, 63, CFGFLAG_SERVER, "Instant Death Weapons")
MACRO_CONFIG_INT(SvFullauto, sv_fullauto, 28, 0, 31, CFGFLAG_SERVER, "Automatic Weapons")
