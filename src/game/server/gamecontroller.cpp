...
bool IGameController::OnEntity(int Index, vec2 Pos)
{
	...
	if(Type != -1 && g_Config.m_SvInsta == 0)
	{
...
void IGameController::OnCharacterSpawn(class CCharacter *pChr)
{
	...
	{
		if(g_Config.m_SvInsta & 1) pChr->GiveWeapon(WEAPON_HAMMER, -1);
		if(g_Config.m_SvInsta & 2) pChr->GiveWeapon(WEAPON_GUN, -1);
		if(g_Config.m_SvInsta & 4) pChr->GiveWeapon(WEAPON_SHOTGUN, -1);
		if(g_Config.m_SvInsta & 8) pChr->GiveWeapon(WEAPON_GRENADE, -1);
